...
def calls2d(database, filedate, slablist, i):
    slab = slablist[i]
    os.system("python s2d.py -p %s -d %s -f %s_%s_input.csv"%(slab,database,slab,filedate))
...
if __name__=='__main__':
    ...
    parser.add_argument('-f', '--filedate', dest='filedate', type=str,
                        required=True, help='MM-YY of most recent database update')
