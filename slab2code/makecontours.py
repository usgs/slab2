...
def main(args):
    ...
    with open('%s/%s_slab2_c%s%i_%s.txt'%(folderdir,slab,cnam,cint,date),'a') as f:
        ...
        for c in contourlist:
            ...
            if cnam == 'dep':
                ...
                dat = supplement[(supplement[args.colname].values < c + maxdiff*0.6) & \
...
if __name__=='__main__':
    ...
    parser.add_argument('-n', '--colname', type=str,
                        required=True, help='column name to make contours of')
